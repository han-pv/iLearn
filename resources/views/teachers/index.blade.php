        ...
        <table class="data-table">
          <thead>
            <tr>
              ...
              <th><i class="bi bi-hash"></i> Image</th>
              ...
              <tr>
                ...
                <td class="w-10">
                  @if($teacher->image_path)
                    <img src="{{ asset('storage/' . $teacher->image_path) }}" alt="Teacher Image" style="width: 50px; height: 50px; object-fit: cover;">
                  @else
                ...
                <td>
                  <div class="table-action-btns">
                    ...
                    <a href="{{ route('teachers.edit', $teacher->id) }}" class="btn-action btn-edit" title="Edit">
