...
@section('content')
    <div class="form-container">
        ...
        <!-- Form Card -->
        <div class="form-card">
            <form action="{{ route('students.store') }}" method="POST" class="form-content">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="enrollment_date" name="enrollment_date" class="form-input" 
                               required value="{{ old('enrollment_date') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea id="bio" name="bio" class="form-input" 
                              placeholder="Enter student biography" rows="4">{{ old('bio') }}</textarea>
                    @error('bio')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
